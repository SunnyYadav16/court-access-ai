      ...
      <div className="px-5 py-3" style={{ background: "#EFF6FF", borderBottom: "1px solid #BFDBFE" }}>
        <div className="max-w-xl mx-auto">
          <p className="text-xs leading-relaxed" style={{ color: "#1e40af" }}>
            👋 <strong>Welcome, Ana.</strong> As an interpreter, you can join active courtroom
            sessions or review and correct AI-generated translations to help improve system
            accuracy using the services below.
          </p>
        </div>
      </div>
