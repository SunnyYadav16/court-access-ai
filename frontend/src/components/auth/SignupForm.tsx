...
/**
 * Render the signup form UI that supports Google/Microsoft OAuth and email/password registration.
 *
 * The component manages local form state, client-side validation (including password strength checks
 * and terms acceptance), and interacts with the central auth store for sign-in and account creation.
 *
 * @returns A JSX element containing the complete signup form and related controls
 */
