...
/**
 * Renders the email verification UI shown when a signed-in user has not verified their email.
 *
 * Displays the target email address, instructions about the verification link, error and status messages,
 * a button to check verification status (which reloads the Firebase user and triggers backend refresh when verified),
 * a cooldown-enabled resend verification action, and an option to change the email address.
 *
 * @returns A React element containing the verification view and related controls.
 */
