...
/**
 * Render the login form with Google, Microsoft, and email/password authentication.
 *
 * Displays OAuth buttons, an email/password form with client-side validation, pending-verification and error banners, and controls to switch modal views (forgot password, signup).
 *
 * @returns The component's JSX element tree for the login UI.
 */
