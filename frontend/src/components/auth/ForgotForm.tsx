...
/**
 * Render the "Forgot your password?" form for use inside the authentication modal.
 *
 * The form validates the email (required and basic format), shows either client-side
 * validation messages or store-provided errors, disables inputs while a reset is in
 * progress, calls the store's password-reset action when submitted, and exposes a
 * control to switch back to the sign-in view.
 *
 * @returns A React element rendering the forgot-password form UI.
 */
