"""
courtaccess/core/tests/test_preprocess_forms.py

Unit tests for courtaccess.core.validation (preprocessing/normalization logic).
Migrated from data_pipeline/tests/test_preprocess_forms.py.

Changes from original:
  - Removed sys.path.insert hack
  - import src.preprocess_forms as pf → import courtaccess.core.validation as pf
"""

from courtaccess.core import validation as pf
...
class TestRunPreprocessing:
    ...
    def test_preprocessing_flags_duplicate_hashes(self, tmp_path):
        catalog = [
            {"form_id": "id1", "content_hash": "hash123"},
            {"form_id": "id2", "content_hash": "hash123"},
            {"form_id": "id3", "content_hash": "hash456"},
        ]
        report = pf.run_preprocessing(catalog, str(tmp_path))
