"""
courtaccess/core/tests/test_pretranslation_pipeline.py

Unit tests for the core/ modules used by form_pretranslation_dag.
Migrated from data_pipeline/tests/test_pretranslation_dag.py.

Changes from original:
  - Removed sys.path.insert hack
  - import src.legal_review as lr → from courtaccess.core import legal_review as lr
  - import src.ocr_printed as ocr  → from courtaccess.core import ocr_printed as ocr
  - import src.reconstruct_pdf as rp → from courtaccess.core import reconstruct_pdf as rp
  - import src.translate_text as tt → from courtaccess.core import translation as tt
"""
...
# ══════════════════════════════════════════════════════════════════════════════
# courtaccess.core.reconstruct_pdf
# ══════════════════════════════════════════════════════════════════════════════
...
class TestReconstructPdf:
    ...
    def test_raises_file_not_found_for_missing_original(self, tmp_path):
        with pytest.raises(FileNotFoundError):
            rp.reconstruct_pdf(str(tmp_path / "missing.pdf"), [], str(tmp_path / "out.pdf"))
